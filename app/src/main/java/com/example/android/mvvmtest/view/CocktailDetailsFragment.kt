...
class CocktailDetailsFragment: Fragment() {
    ...
    // todo display the date binding.tv......
    ...
    private fun updateUI(data: CocktailDetails) {
        ...
        Picasso.get().load(data.drinks[0].strDrinkThumb).placeholder(R.drawable.ic_launcher_foreground).into(binding.cocktailImageThumb)
    }
